            ...
            <div className="py-12 flex gap-8 justify-between">
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <h6 className="text-neutral-500 text-sm font-bold leading-normal tracking-tight">Career</h6>
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col items-start">
                        <div className="flex items-center">
                            <input type="text" placeholder="Your Email" className="p-2.5 border rounded-l-md text-neutral-500 font-normal leading-7 tracking-tight bg-stone-50 " />
